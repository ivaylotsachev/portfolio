...
const worksOnce = (container) => {
    ...
    tl
        .from(workImageWrapper, { yPercent: -110, stagger: 0.05}, 0)
        .from(workImage, { yPercent: 110, stagger: 0.05, scale: 1.2}, 0)
